  ...
  try {
    ...
    const chat = model.startChat({
      ...
      history: [
        {
          role: "user",
          parts: [{ text: "Ich werde dir Aufgabenbeschreibungen in natürlicher Sprache geben. Du sollst sie analysieren und in strukturierte Daten umwandeln." }],
        },
        {
          role: "model",
          parts: [{ text: "Ich bin bereit, deine Aufgabenbeschreibungen zu analysieren und in strukturierte Daten umzuwandeln. Ich werde alle wichtigen Informationen extrahieren und als JSON zurückgeben." }],
        },
      ],
    });
