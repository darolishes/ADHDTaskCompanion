...
export function TaskListView({
  ...
  if (isLoading) {
    return (
      <div className="py-10 flex-center flex-col space-y-4">
  ...
  return (
    <div className="mb-8">
      {tasks.length > 0 ? (
        ...
        <div
          className={cn(
            "text-center py-10 card-base transition-all duration-500",
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-4 max-w-md mx-auto">
            Ready to be productive? Add your first task using the form above and
            our AI will help break it down into manageable steps.
          </p>
          <div className="flex-center space-x-2 text-xs text-muted-foreground">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="12"
              height="12"
